...
import spiglet.main.PrintKanga;
...
public class Spiglet2Kanga extends GJDepthFirst<String,String> {
	...
	//find the value of this variable in the memory
    ...
    //store the value of the variable back to the memory
    ...
    public String visit(StmtExp n, String argu) {
        ...
        //put the parameters in spiglet's register to kanga's register
        if(curProc.argNum <= 4) {
    ...
    public String visit(Call n, String argu) {
        ...
        //construct call statement and return value
